...
(defun new-append-directories (absolute-dir relative-dir)
  ...
  (let* ((abs-dir (pathname absolute-dir))
	 ...
	 ;; ;madhu 200229 add clozure ;madhu 221124 ecl (lpn)
         #-(or :MCL :sbcl :clisp :cmu :ecl :clozure-common-lisp) (rel-file (file-namestring rel-dir))
	 ;; Stig (July 2001);
	 ;; These values seems to help clisp as well
	 #+(or :MCL :sbcl :clisp :cmu :ecl :clozure-common-lisp) (rel-name (pathname-name rel-dir))
	 #+(or :MCL :sbcl :clisp :cmu :ecl :clozure-common-lisp) (rel-type (pathname-type rel-dir))
	 (directory nil))
    ...
    (namestring
     (make-pathname :host host
		    :device device
                    ...
                    directory
		    :name
		    #-(or :sbcl :MCL :clisp :cmu :ecl :clozure-common-lisp) rel-file
		    #+(or :sbcl :MCL :clisp :cmu :ecl :clozure-common-lisp) rel-name

		    #+(or :sbcl :MCL :clisp :cmu :ecl :clozure-common-lisp) :type
		    #+(or :sbcl :MCL :clisp :cmu :ecl :clozure-common-lisp) rel-type
		    ))))
